...
let handler = async function (m, { text, usedPrefix, command }) {
  ...
  if (user.registered === true) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          "title": '*Verify*',
          "description": 'Halo ${name} Kamu Sudah Terdaftar,Mau Daftar Ulang?',
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": `LIST MENU`,
                                         "description": "List Menu EX BOT",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `MY OWNER`,
                                         "description": "List Owner EX BOT", 
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `UNREGISTER`,
